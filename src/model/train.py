...
def load_snapshots(snapshot_dir):
    ...
    for f in files:
        ...
        # maintain node order as given in file
...
def train_model(graphs, model_save_dir="models", epochs=80, batch_size=2, lr=1e-3):
    ...
    meta = {"in_channels": in_channels, "epochs": epochs}
